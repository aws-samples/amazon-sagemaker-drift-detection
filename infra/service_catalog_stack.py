...
class ServiceCatalogStack(core.Stack):
    def __init__(
        ...
        **kwargs,
        ...
        self.export_ssm(
            "CodeCommitDemoKey", demo_asset.s3_object_key, products_launch_role
        )
